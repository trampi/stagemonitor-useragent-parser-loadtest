 ...
 */
@Deprecated
public class UserAgentParserSynchronizedBlock2 implements UAP {
	...
	public UserAgentParserSynchronizedBlock2() {
	...
	public UserAgentParserSynchronizedBlock2(UserAgentStringParser parser, Map<String, ReadableUserAgent> userAgentCache) {
		this.parser = parser;
	...
	private synchronized ReadableUserAgent parse(String userAgentHeader) {
