 ...
 */
@Deprecated
public class UserAgentParserSynchronizedBlock implements UAP {
	...
	public UserAgentParserSynchronizedBlock() {
	...
	public UserAgentParserSynchronizedBlock(UserAgentStringParser parser, Map<String, ReadableUserAgent> userAgentCache) {
		this.parser = parser;
		this.userAgentCache = userAgentCache;
	}

	public synchronized void setUserAgentInformation(final Span span, final String userAgentHeader) {
