 ...
 */
@Deprecated
public class UserAgentParserSynchronizedMap implements UAP {
	...
	public UserAgentParserSynchronizedMap() {
	...
	public UserAgentParserSynchronizedMap(UserAgentStringParser parser, Map<String, ReadableUserAgent> userAgentCache) {
		this.parser = parser;
		this.userAgentCache = Collections.synchronizedMap(userAgentCache);
	}
